...
The architecture was designed jointly; the table records who led each part and who
produced the artefacts in this document.
...
\midrule
\memberA & Frontend architect &
  Dashboard SPA: component design, Fleet Pulse, charts and the accessibility rules;
  frontend views in this document; deployment pipeline \\
\memberB & \textit{[role]} & \textit{[contribution]} \\
\memberC & \textit{[role]} & \textit{[contribution]} \\
\memberD & \textit{[role]} & \textit{[contribution]} \\
\bottomrule
\end{tabularx}
\end{center}
...
\medskip
\noindent
Source history is public at \url{https://github.com/innoenjoyer/is3-dashboard}, so
individual contributions are verifiable in the commit log.
